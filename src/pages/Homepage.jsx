        ...
        <div className="homepage-hero">
          ...
          <div className="homepage-tekst">
            ...
            <p>
              ...
              er fede OG funktionelle. Jeg læser på interaction design linjen på
              akademiet og har mine styrker i UX/UI samt React og Figma. Jeg vil
              gerne lære så meget jeg kan, så lad os få en snak om en
              praktikplads!
            </p>
          </div>
        </div>
